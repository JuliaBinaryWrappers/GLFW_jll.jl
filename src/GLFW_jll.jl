...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GLFW_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0656b61e-2033-5cc2-a64a-77c0f6c09b89"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GLFW", artifacts_toml) for e in artifacts["GLFW"]]
...
if best_platform === nothing
    @debug("Unable to load GLFW; unsupported platform $(triplet(platform_key_abi()))")
else
