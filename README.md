# `GLFW_jll.jl` (v3.5.1+0)

[![deps](https://juliahub.com/docs/GLFW_jll/deps.svg)](https://juliahub.com/ui/Packages/General/GLFW_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/6e4125c91d946aadb457e5f8a171cce91b735a20/G/GLFW/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/glfw/glfw.git (revision: `d9d6f0f1f967807ffade6598ea9a631ebaf37a56`)
